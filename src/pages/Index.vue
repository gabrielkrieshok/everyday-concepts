<template>
  <Layout>
    <section id="container-centre" class="column centre flex-1">
      <h1 class="page-title"><span class="font-light">Welcome to </span>Everyday Concepts</h1>
      <div class="content">
        <p>Exploring the concepts, ideas, and mental models that construct our lives.</p>
        
        <h2 class="text-3xl">Latest Concepts</h2>
        ...
        <div class="flex w-full md:w-1/3 mb-8 px-2" v-for="concept in filteredData" :key="concept.node.id">
          ...
          <p>Explore all of the <a href="/concepts/">concepts</a> and <a href="/sketches/">sketches</a>.</p>
